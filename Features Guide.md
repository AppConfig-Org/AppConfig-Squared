...
### Enhanced Dashboard
- **Portfolio Overview** - Real-time metrics and insights across your application portfolio
- **Interactive Metrics** - Clickable dashboard cards that filter and navigate to specific applications
- **Security Scorecard** - Quick security posture assessment with detailed breakdowns
- **Application Statistics** - Dynamic counts by type, tenant configuration, and security metrics
- **Smart Navigation** - Tool-aware navigation that adapts based on selected functionality
...
> 💡 **Need Help?** Contact our support team at [support@AppConfig.app](mailto:support@AppConfig.app) for assistance with any feature across the AppConfig² Suite.
